...
#define PROTOCOL_VERSION 100              // bump when protocol changes
...
{
    { GUN_RAIL,  ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_RAIL1,  S_RAIL2, 1300, 85, 0, 0,    0, 30, 2048, 1, 25,  0, 0, 0 },
    ...
    { GUN_MACH, ACT_SHOOT, ANIM_SHOOT, ANIM_VWEP_SHOOT, ANIM_GUN_SHOOT, S_MACH,  S_MACH,  100, 5, 10, 10,    0, 5, 2048, 1, 25,  0, 0, 0 },
